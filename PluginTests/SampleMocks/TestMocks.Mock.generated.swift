...
open class CLLocationManagerMock: CLLocationManager, Mock {
    ...
    public struct MethodExpectation<Signature> {
        ...
        @available(macOS, introduced: 10.8, deprecated: 100000)
    ...
    @available(macOS 10.15, *)
    public override func requestWhenInUseAuthorization() -> Void {
    ...
    @available(macOS 10.15, *)
    public override func requestAlwaysAuthorization() -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS 11.0, *)
    public override func requestTemporaryFullAccuracyAuthorization(withPurposeKey purposeKey: String, completion: (@Sendable ((any Error)?) -> Void)?) -> Void {
        guard !autoForwardingEnabled else {
    ...
    public override func startUpdatingLocation() -> Void {
        guard !autoForwardingEnabled else {
    ...
    public override func stopUpdatingLocation() -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.14, *)
    public override func requestLocation() -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.15, *)
    public override func startUpdatingHeading() -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.15, *)
    public override func dismissHeadingCalibrationDisplay() -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.7, *)
    public override func startMonitoringSignificantLocationChanges() -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.7, *)
    public override func stopMonitoringSignificantLocationChanges() -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.15, deprecated: 10.15)
    public override func startMonitoring(for region: CLRegion, desiredAccuracy accuracy: CLLocationAccuracy) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.8, deprecated: 100000)
    public override func stopMonitoring(for region: CLRegion) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.8, deprecated: 100000)
    public override func startMonitoring(for region: CLRegion) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.8, deprecated: 100000)
    public override func requestState(for region: CLRegion) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 11.0, deprecated: 11.0, message: "Use -startRangingBeaconsSatisfyingConstraint:")
    public override func startRangingBeacons(in region: CLBeaconRegion) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 11.0, deprecated: 11.0, message: "Use -stopRangingBeaconsSatisfyingConstraint:")
    public override func stopRangingBeacons(in region: CLBeaconRegion) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.15, *)
    public override func startRangingBeacons(satisfying constraint: CLBeaconIdentityConstraint) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.15, *)
    public override func stopRangingBeacons(satisfying constraint: CLBeaconIdentityConstraint) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.15, deprecated: 10.15, message: "You can remove calls to this method")
    public override func allowDeferredLocationUpdates(untilTraveled distance: CLLocationDistance, timeout: TimeInterval) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.15, deprecated: 10.15, message: "You can remove calls to this method")
    public override func disallowDeferredLocationUpdates() -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(*, deprecated, message: "Objective-C garbage collection is no longer supported")
    public override func finalize() -> Void {
        guard !autoForwardingEnabled else {
    ...
    public override func doesNotRecognizeSelector(_ aSelector: Selector!) -> Void {
        guard !autoForwardingEnabled else {
    ...
    @available(macOS 11.0, *)
        public override var accuracyAuthorization: CLAccuracyAuthorization {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS 11.0, *)
        public override var isAuthorizedForWidgetUpdates: Bool {
        get {
            guard !autoForwardingEnabled else {
    ...
    public override var delegate: (any CLLocationManagerDelegate)? {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.15, deprecated: 10.15)
        public override var locationServicesEnabled: Bool {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.7, deprecated: 11.0, message: "Set the purpose string in Info.plist using key NSLocationUsageDescription")
        public override var purpose: String? {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.15, *)
        public override var pausesLocationUpdatesAutomatically: Bool {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.15, deprecated: 10.15)
        public override var headingAvailable: Bool {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.15, *)
        public override var headingFilter: CLLocationDegrees {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.15, *)
        public override var headingOrientation: CLDeviceOrientation {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.8, *)
        public override var maximumRegionMonitoringDistance: CLLocationDistance {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.8, *)
        public override var monitoredRegions: Set<CLRegion> {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS, introduced: 10.15, deprecated: 10.15, message: "Use -rangedBeaconConstraints")
        public override var rangedRegions: Set<CLRegion> {
        get {
            guard !autoForwardingEnabled else {
    ...
    @available(macOS 10.15, *)
        public override var rangedBeaconConstraints: Set<CLBeaconIdentityConstraint> {
        get {
            guard !autoForwardingEnabled else {
