...
final class InternalMockableMock: InternalMockable, Mock {
    enum Methods {
    ...
    struct MethodExpectation<Signature> {
        ...
        static func doSomething(with internal: Parameter<Internal>) -> Self
        ...
        static func doSomething(withAny any: Parameter<Any>) -> Self
...
final class InternalSubclassOfAPublicClassMock: InternalSubclassOfAPublicClass, Mock {
    enum Methods {
    ...
    struct PropertyExpectation<Signature> {
        ...
        var getterExpectation: Recorder.Expectation {
            .init(
                method: method,
                parameters: []
            )
        ...
        func setterExpectation(_ newValue: AnyParameter) -> Recorder.Expectation {
            .init(
                method: method,
                parameters: [newValue]
            )
    ...
    var autoForwardingEnabled: Bool
...
extension InternalSubclassOfAPublicClassMock.PropertyExpectation where Signature == () -> Int {
    static var value: Self {
        .init(method: InternalSubclassOfAPublicClassMock.Methods.value_sync_ret_Int)
    }
}

extension InternalSubclassOfAPublicClassMock.PropertyExpectation where Signature == (_ newValue: Int) -> Void {
    static var value: Self {
        .init(method: InternalSubclassOfAPublicClassMock.Methods.set_value_sync_ret_Int)
    }
}

final class ObjCMockableMock: ObjCMockable, Mock {
    enum Methods {
    ...
    struct MethodExpectation<Signature> {
        ...
        static func doSomething(with int: Parameter<Int>) -> Self
...
final class RefinedGenericProtocolMock<Base: Identifiable>: RefinedGenericProtocol, Mock {
    typealias Base = Base
    typealias A = Base.ID
    typealias B = Base
    ...
    struct MethodExpectation<Signature> {
        ...
        static func value(for key: Parameter<A>) -> Self
    ...
    struct SubscriptExpectation<Signature> {
        private let method: MockMethod
        ...
        static var `subscript`: RefinedGenericProtocolMock.SubscriptExpectations { .init() }
    }

    struct SubscriptExpectations {
        subscript(key: Parameter<Int>) -> RefinedGenericProtocolMock.SubscriptExpectation<(_ key: Int) -> String> {
            .init(
        ...
        subscript(key: Parameter<Int>) -> RefinedGenericProtocolMock.SubscriptExpectation<(Int, _ newValue: String) -> Void> {
            .init(
        ...
        subscript(key: Parameter<A>) -> RefinedGenericProtocolMock.SubscriptExpectation<(_ key: A) -> B> {
            .init(
        ...
        subscript(key: Parameter<A>) -> RefinedGenericProtocolMock.SubscriptExpectation<(A, _ newValue: B) -> Void> {
            .init(
...
extension RefinedGenericProtocolMock.PropertyExpectation where Signature == () -> RefinedGenericProtocolMock.A {
    static var a: Self {
        .init(method: RefinedGenericProtocolMock.Methods.a_sync_ret_A)
    }
}

extension RefinedGenericProtocolMock.PropertyExpectation where Signature == (_ newValue: RefinedGenericProtocolMock.A) -> Void {
    static var a: Self {
        .init(method: RefinedGenericProtocolMock.Methods.set_a_sync_ret_A)
    }
}

extension RefinedGenericProtocolMock.PropertyExpectation where Signature == () -> RefinedGenericProtocolMock.Base {
    static var base: Self {
        .init(method: RefinedGenericProtocolMock.Methods.base_sync_ret_Base)
    }
}

extension RefinedGenericProtocolMock.PropertyExpectation where Signature == (_ newValue: RefinedGenericProtocolMock.Base) -> Void {
    static var base: Self {
        .init(method: RefinedGenericProtocolMock.Methods.set_base_sync_ret_Base)
    }
}

final class SourceryIssue1Mock<Bar>: SourceryIssue1, Mock {
    typealias Bar = Bar
...
extension SourceryIssue1Mock.PropertyExpectation where Signature == () -> SourceryIssue1Mock.Bar {
    static var value: Self {
        .init(method: SourceryIssue1Mock.Methods.value_sync_ret_Bar)
    }
}

final class TestableMockableMock: TestableMockable, Mock {
    enum Methods {
    ...
    struct MethodExpectation<Signature> {
        ...
        static func doSomething(with internal: Parameter<InternalMockableParameter>) -> Self
